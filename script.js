...
smileyButton.addEventListener("click", function () { 
  ...
  if (count % 2 == 0) {
    ...
    faceElement.style.backgroundColor = "#1d5fa1";
  } else { 
    document.body.style.backgroundColor = "#1f5285";
    faceElement.style.backgroundColor = ""; // Återställ bakgrundsfärgen för ".face"
  }
});
